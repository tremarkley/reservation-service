      ...
      <div className="outer-calendar-pop-up">
        <div className="inner-calendar-pop-up">
          <div className="calendar-holder">
            <button className="left-arrow" style={{ backgroundImage: 'url(/images/left-arrow.png)' }} onClick={this.leftArrowClick} />
            <h4 className="calendar-header">{`${monthName.long[this.state.month]} ${this.state.year}`}</h4>
            <button className="right-arrow" style={{ backgroundImage: 'url(/images/right-arrow.png)' }} onClick={this.rightArrowClick} />
